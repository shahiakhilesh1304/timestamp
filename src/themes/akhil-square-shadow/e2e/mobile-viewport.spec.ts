/**
 * AkhilSquareShadow Theme Mobile Viewport Tests
 *
 * Tests mobile viewport behavior specific to the akhil-square-shadow theme.
...
const TEST_URL = '/?theme=akhil-square-shadow&mode=wall-clock&target=2099-01-01T00:00:00';

test.describe('AkhilSquareShadow Theme: Mobile Viewport', () => {
...
test.describe('AkhilSquareShadow Theme: Mobile Layout', () => {
